...
Our most predictive model is a type of neural network model using the sklearn package. The model is called GradientBoostingRegressor. Gradient Boosting = Gradient descent + Boosting.
...
-	the Hyperparameters used in the model are shown above. They were ultimately selected by a grid search method. 
